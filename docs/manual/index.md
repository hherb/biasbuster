...
```
Collect ──> Enrich ──> Annotate ──> Human Review ──> Export
                                                       │
...
This runs stages 1-4 (collect, enrich, annotate, export) sequentially. However, you will typically want to run each stage individually and review the results between steps. The manual pages above walk you through each stage in detail.
