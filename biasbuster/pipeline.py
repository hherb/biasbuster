...
async def stage_enrich(config: Config, db: Database) -> None:
    ...
    """
    from biasbuster.enrichers.effect_size_auditor import audit_abstract, ReportingPattern
    ...
    from biasbuster.collectors.clinicaltrials_gov import ClinicalTrialsGovCollector
...
def create_annotator(
    ...
    if model_name == "anthropic":
        ...
        from biasbuster.annotators.openai_compat import OpenAICompatAnnotator
...
async def stage_compare(config: Config, db: Database) -> None:
    ...
    from biasbuster.evaluation.comparison import generate_comparison, save_report
