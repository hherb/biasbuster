...
from biasbuster.crowd.pages.annotate import register_annotate_page
from biasbuster.crowd.pages.dashboard import register_dashboard_page
from biasbuster.crowd.pages.login import register_login_pages
from biasbuster.crowd.pages.reveal import register_reveal_page
