...
| sonnet_4_6_abstract_pass1 | 76 | 0.447 | 0.064 | 0.095 [-0.008, 0.211] | 0.151 |
| sonnet_4_6_abstract_pass2 | 76 | 0.447 | 0.087 | 0.081 [-0.010, 0.189] | 0.072 |
| sonnet_4_6_abstract_pass3 | 77 | 0.481 | 0.135 | 0.155 [0.035, 0.289] | 0.189 |
| sonnet_4_6_fulltext_pass1 | 64 | 0.422 | 0.063 | 0.077 [-0.057, 0.190] | 0.101 |
| sonnet_4_6_fulltext_pass2 | 69 | 0.478 | 0.148 | 0.200 [0.056, 0.346] | 0.281 |
| sonnet_4_6_fulltext_pass3 | 67 | 0.478 | 0.166 | 0.197 [0.036, 0.339] | 0.246 |
...
| Claude Sonnet 4.6 × abstract | 3 | 0.509 | 0.509 | 0.509 |
| Claude Sonnet 4.6 × fulltext | 3 | 0.736 | 0.742 | 0.752 |
...
| Source | n | raw agr | κ_unw | κ_lin (95% CI) | κ_quad |
|---|---:|---:|---:|---|---:|
| gpt_oss_20b_abstract_ensemble | 78 | 0.436 | 0.054 | 0.023 [-0.061, 0.125] | -0.031 |
| gpt_oss_20b_fulltext_ensemble | 78 | 0.449 | 0.157 | 0.186 [0.053, 0.307] | 0.223 |
| gemma4_26b_abstract_ensemble | 78 | 0.462 | 0.122 | 0.127 [0.006, 0.254] | 0.134 |
| gemma4_26b_fulltext_ensemble | 78 | 0.436 | 0.146 | 0.176 [0.044, 0.305] | 0.212 |
| qwen3_6_35b_abstract_ensemble | 78 | 0.423 | 0.046 | 0.077 [-0.032, 0.205] | 0.126 |
| qwen3_6_35b_fulltext_ensemble | 78 | 0.500 | 0.207 | 0.227 [0.071, 0.362] | 0.253 |
| sonnet_4_6_abstract_ensemble | 78 | 0.474 | 0.110 | 0.124 [0.016, 0.228] | 0.148 |
| sonnet_4_6_fulltext_ensemble | 78 | 0.474 | 0.141 | 0.182 [0.036, 0.333] | 0.246 |
...
| sonnet_4_6_abstract_pass1 | 0.025 | 0.149 | 0.265 | 0.196 | 0.042 | 0.151 |
| sonnet_4_6_abstract_pass2 | 0.036 | 0.163 | 0.248 | 0.220 | 0.074 | 0.072 |
...
| sonnet_4_6_fulltext_pass1 | 0.191 | 0.146 | 0.361 | 0.340 | 0.082 | 0.101 |
| sonnet_4_6_fulltext_pass2 | 0.176 | 0.153 | 0.335 | 0.390 | 0.097 | 0.281 |
| sonnet_4_6_fulltext_pass3 | 0.174 | 0.169 | 0.380 | 0.327 | 0.082 | 0.246 |
...
| Claude Sonnet 4.6 (abstract, pass 1) | 0.151 | 0.095 [-0.008, 0.211] | 76 |
| Claude Sonnet 4.6 (abstract, pass 2) | 0.072 | 0.081 [-0.010, 0.189] | 76 |
| Claude Sonnet 4.6 (abstract, pass 3) | 0.189 | 0.155 [0.035, 0.289] | 77 |
| Claude Sonnet 4.6 (fulltext, pass 1) | 0.101 | 0.077 [-0.057, 0.190] | 64 |
| Claude Sonnet 4.6 (fulltext, pass 2) | 0.281 | 0.200 [0.056, 0.346] | 69 |
| Claude Sonnet 4.6 (fulltext, pass 3) | 0.246 | 0.197 [0.036, 0.339] | 67 |
| gpt-oss 20B (abstract, ensemble) | -0.031 | 0.023 [-0.061, 0.125] | 78 |
| gpt-oss 20B (fulltext, ensemble) | 0.223 | 0.186 [0.053, 0.307] | 78 |
| Gemma 4 26B-A4B (abstract, ensemble) | 0.134 | 0.127 [0.006, 0.254] | 78 |
| Gemma 4 26B-A4B (fulltext, ensemble) | 0.212 | 0.176 [0.044, 0.305] | 78 |
| Qwen 3.6 35B-A3B (abstract, ensemble) | 0.126 | 0.077 [-0.032, 0.205] | 78 |
| Qwen 3.6 35B-A3B (fulltext, ensemble) | 0.253 | 0.227 [0.071, 0.362] | 78 |
| Claude Sonnet 4.6 (abstract, ensemble) | 0.148 | 0.124 [0.016, 0.228] | 78 |
| Claude Sonnet 4.6 (fulltext, ensemble) | 0.246 | 0.182 [0.036, 0.333] | 78 |
